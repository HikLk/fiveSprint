...
func (t Training) Calories() float64 { return 0 }
...
func (r Running) Calories() float64 {
	multiSpeed := CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift

	return multiSpeed * r.Weight / MInKm * r.Duration.Hours() * MinInHours
}
...
func (w Walking) Calories() float64 {
	...
	return shiftedWeight * multiWeight * multiDuration
}
...
func (s Swimming) Calories() float64 {
	multiSpeed := s.meanSpeed() + SwimmingCaloriesMeanSpeedShift

	return multiSpeed * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
}
